                  ...
                  <Box mb={2}>
                    ...
                    >
                      ...
                      >
                        <Typography>
                          Detail{" "}
                          {showDetail ? "de la construction" : "du calcul"}{" "}
                        </Typography>
                      </Button>
                  ...
                  <Box>
                    <Typography variant="h5">
                      ...
                      {construction.impot !== null &&
                        formatter(construction.impot) + " Ariary"}{" "}
                    </Typography>{" "}
                    <Typography>ID: {construction.numcons}</Typography>
                    <Box>Loyer mensuel: {construction.loyer}</Box>
                  </Box>
                </Box>
                <img
                  style={{
